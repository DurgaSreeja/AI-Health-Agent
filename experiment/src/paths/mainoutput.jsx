      ...
      return (
        <>
          ...
          >
            ...
            >
              <h2 style={{ fontFamily: "initial", color: "aliceblue" }}>
                Risk level:
              </h2>
              <p>
                <b style={{ color: "aliceblue", color: "aliceblue" }}>
                  {k}
                  <span>%</span>
                </b>
              </p>
      ...
      return (
        ...
        >
          ...
          >
            ...
            <p>
              <b style={{ color: "aliceblue", color: "black" }}>
                {k}
                <span>%</span>
              </b>
            </p>
      ...
      {loading ? (
        ...
        <>
          ...
          >
            ...
            <div className="offcanvas-body">
              <div className="details">
                ...
                >
                  <div style={{ fontSize: "2.2rem", marginLeft: "10px" }}>
                    {k}%
                  </div>
          ...
          >
            ...
            >
              <h2 style={{ marginLeft: "180px", marginTop: "30px" }}>
                Life expantansy
              </h2>
              <div
                style={{
              ...
              >
                <div style={{ fontFamily: "fantasy", fontSize: "2rem" }}>
                  {100 - k}%
                </div>
                <div
                  style={{
                ...
                >
                  Don't lose hope! Even if your heart health is at high risk,
                  there's still a chance to recover. Take proactive steps,
                  follow medical advice, and make healthy lifestyle choices to
            ...
            >
              ...
              >
                Recovery is possible! By following a balanced diet plan and
                staying committed to your health, you can improve your heart
                condition. Embrace the journey to wellness with confidence and
                determination.{" "}
              </div>
              <Link
                to="/dietplan"
