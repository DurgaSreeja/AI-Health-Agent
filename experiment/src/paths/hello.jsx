  ...
  return (
    <div>
          ...
          <div className="container-fluid">
            ...
            >
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                >
                  Search{" "}
                  <i style={{ color: "#e11127" }} className="bi bi-search"></i>
                </Link>
                <div
                  style={{
                    position: "absolute",
                ...
                >
                  ...
                  <a style={{ fontSize: "1.2rem", marginLeft: "10px" }}>{ud}</a>
                </div>
              </ul>
            </div>
          </div>
      ...
      >
        ...
        <footer
          style={{ width: "100%", backgroundColor: "#e11127", height: "15px" }}
        ></footer>
      </div>

      <div
        className="body1"
        style={{ height: "400px", width: "100%", backgroundColor: "aliceblue" }}
      >
        <h1
          className="heartbeat"
          style={{
      ...
      <div
        className="middle"
        style={{ height: "600px", width: "100%", backgroundColor: "aliceblue" }}
      >
        <div
          className="middle1 shadow-lg"
          style={{
            height: "500px",
            backgroundColor: "aliceblue",
            width: "600px",
        ...
        <div
          ...
          style={{
            ...
            marginTop: "100px",
            left: "300px",
            borderBottom: "15px #e11127 solid",
          }}
        >
          <div
            className="text1"
      ...
      <div
        className="dash"
        style={{ height: "70px", backgroundColor: "#e11127", width: "100%" }}
      ></div>
      ...
      <div className="next" style={{ display: "flex", marginTop: "30px" }}>
        ...
        >
          ...
          <div className="card-body">
            ...
            <p className="card-text">Generate Diet Plan</p>
            <Link
              to="/dietplan"
              className="btn"
